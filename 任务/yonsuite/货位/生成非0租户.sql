...
set @billno = 'aa_goodsproductscomparison_position';
set @filterName='aa_goodsproductscomparison_position';
set @solutionName='aa_goodsproductscomparison_position';
...
insert into bill_base(`sysid`,`cBillNo`,`cName`,`cCardKey`,`cSubId`,`iDefTplId`,`iDefPrnTplId`,`iOrder`,`bAllowMultiTpl`,`cDefWhere`,`isDeleted`,`bPrintLimited`,`iSystem`,`cAuthId`,`cBillType`,`cBeanId`,`cFilterId`,`bRowAuthControl`,`bColumnAuthControl`,`bRowAuthObject`,`bColumnAuthControlled`,`bRowAuthControlled`,`cPersonDataSource`,`cCarry`,`authGroupKey`,`datasourcetype`,`datasourcesql`,`batchoperate`,`authType`,`tenant_id`,`pkField`,`parentField`,`i18ndoc`)
select bill_base.id,`cBillNo`,`cName`,`cCardKey`,`cSubId`,`iDefTplId`,`iDefPrnTplId`,`iOrder`,`bAllowMultiTpl`,`cDefWhere`,`isDeleted`,`bPrintLimited`,`iSystem`,`cAuthId`,`cBillType`,`cBeanId`,`cFilterId`,`bRowAuthControl`,`bColumnAuthControl`,`bRowAuthObject`,`bColumnAuthControlled`,`bRowAuthControlled`,`cPersonDataSource`,`cCarry`,`authGroupKey`,`datasourcetype`,`datasourcesql`,`batchoperate`,`authType`,tenant.id,pkField,parentField,i18ndoc
from bill_base
...
insert into billitem_base(`sysid`,`iBillId`,`iBillEntityId`,`iTplId`,`iBillTplGroupId`,`cSubId`,`cFieldName`,`cName`,`cCaption`,`cShowCaption`,`iOrder`,`iMaxLength`,`iFieldType`,`bEnum`,`cEnumString`,`isDeleted`,`bMustSelect`,`bHidden`,`cRefType`,`cRefId`,`cRefRetID`,`cDataRule`,`iFunctionType`,`bSplit`,`bExtend`,`iNumPoint`,`bCanModify`,`cSourceType`,`iMaxShowLen`,`cMemo`,`iColWidth`,`cSumType`,`iAlign`,`bNeedSum`,`bShowIt`,`bFixed`,`bFilter`,`cDefaultValue`,`cFormatData`,`cUserId`,`iTabIndex`,`bIsNull`,`bPrintCaption`,`bJointQuery`,`bPrintUpCase`,`bSelfDefine`,`cDataSourceName`,`cOrder`,`bCheck`,`cControlType`,`cEnumType`,`refReturn`,`bShowInRowAuth`,`iRowAuthBillId`,`cStyle`,`cSelfDefineType`,`bVmExclude`,`bRowAuthDim`,`isprint`,`multiple`,`tenant_id`,`isshoprelated`,`depends`,isExport)
select billitem_base.id,bill.iBillId,bill.iBillEntityId,bill.iTplId,bill.iBillTplGroupId,billitem_base.cSubId,`cFieldName`,billitem_base.cName,`cCaption`,`cShowCaption`,billitem_base.iOrder,`iMaxLength`,`iFieldType`,`bEnum`,`cEnumString`,billitem_base.isDeleted,`bMustSelect`,`bHidden`,`cRefType`,`cRefId`,`cRefRetID`,`cDataRule`,`iFunctionType`,`bSplit`,`bExtend`,`iNumPoint`,`bCanModify`,`cSourceType`,`iMaxShowLen`,billitem_base.cMemo,`iColWidth`,`cSumType`,`iAlign`,`bNeedSum`,`bShowIt`,`bFixed`,`bFilter`,`cDefaultValue`,`cFormatData`,`cUserId`,`iTabIndex`,billitem_base.bIsNull,`bPrintCaption`,`bJointQuery`,`bPrintUpCase`,`bSelfDefine`,billitem_base.cDataSourceName,`cOrder`,`bCheck`,`cControlType`,`cEnumType`,`refReturn`,`bShowInRowAuth`,`iRowAuthBillId`,billitem_base.cStyle,`cSelfDefineType`,`bVmExclude`,`bRowAuthDim`,billitem_base.isprint,`multiple`,tenant.id,`isshoprelated`,`depends`,isExport
from billitem_base
left join tenant on 1=1  and isOpen = 1
...
select id into @solutionidzero from pb_filter_solution where tenant_id=0 and filtersid in (select id from pb_meta_filters where filterName=@filterName);
